...
public class usine extends javax.swing.JPanel {
    ...
    private void updateFactory(int dp, int yp, int en,
        ...
        iss.update("UPDATE factory "
                + "SET daily_p = "+dp
                +", yearly_p = "+yp+", employee_n = "+en
    ...
    private void renderFactoryCosts(){
       ...
       dpFactoryField.setText(String.valueOf(dp));
        ypFactoryField.setText(String.valueOf(yp));
        enFactoryField.setText(String.valueOf(en));
        rcFactoryField.setText(String.valueOf(rc));
        ecFactoryField.setText(String.valueOf(ec));
        tcFactoryField.setText(String.valueOf(tc));
        repcFactoryField.setText(String.valueOf(repc));
        fcFactoryField.setText(String.valueOf(fc));
    }
    ...
    private void initComponents() {
        ...
        dpFactoryField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                dpFactoryFieldKeyReleased(evt);
            }
        });
    ...
    private void kButton24MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_kButton24MouseClicked
        if(dpFactoryField.isEnabled()){
            ...
            if(n == 0){
                ...
                Double rc = Double.valueOf(rcFactoryField.getText());
                Double ec = Double.valueOf(ecFactoryField.getText());
    ...
    private void dpFactoryFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dpFactoryFieldKeyReleased
        int en = Integer.parseInt(dpFactoryField.getText());
        ypFactoryField.setText(String.valueOf(en*365));
    }//GEN-LAST:event_dpFactoryFieldKeyReleased
